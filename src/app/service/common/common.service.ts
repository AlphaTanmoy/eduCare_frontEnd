...
export class CommonService {
  ...
  getAllAvailableSubCourseByFranchise(userId: string | null): Observable<any> {
    return this.http.get<any>(GetBaseURL() + Endpoints.common.get_all_subcourse_by_franchise + "/" + userId);
  }
}
