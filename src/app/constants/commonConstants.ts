...
export const MasterDataType = {
  ...
  HAPPY_STUDENT: 'HAPPY_STUDENT',
  TOTAL_STUDENT: 'TOTAL_STUDENT',
}

export enum COUNTER_TYPE {
  REGISTRATION_NUMBER_SERIAL = "REGISTRATION_NUMBER_SERIAL",
  CERTIFICATION_NUMBER_SERIAL = "CERTIFICATION_NUMBER_SERIAL",
  FRANCHISE_NUMBER_SERIAL = "FRANCHISE_NUMBER_SERIAL",
  NOTIFICATION_NUMBER_SERIAL = "NOTIFICATION_NUMBER_SERIAL",
  YT_LINK_SERIAL = "YT_LINK_SERIAL",
  CONTACT_TICKET_SERIAL = "CONTACT_TICKET_SERIAL"
}
